...
async def display_subscription_options(
    ...
    if active and not force_show_options:
            ...
            inline_keyboard = [
                ...
                [
                    InlineKeyboardButton(
                        ...
                        callback_data="subscription_action:view_options",
                    )
                ],
                [
                    InlineKeyboardButton(
...
@router.callback_query(F.data == "subscription_action:view_options")
async def show_options_from_active_callback(
    callback: types.CallbackQuery,
    i18n_data: dict,
    settings: Settings,
    session: AsyncSession,
